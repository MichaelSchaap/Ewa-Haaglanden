      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            >Ewa Haaglanden! De noodzakelijke alliantie voor arbeidsparticipatie</h2>
            <h5 class="description" style="color:black; text-align:left">
              ...
              <br />
              <br />De huidige situatie op de arbeidsmarkt is een uitstekende uitgangspositie.
              ...
              <br />
              <br />Terwijl dat personeel in potentie wel aanwezig is.
              ...
              <br />
              <br />We kunnen echter constateren (zonder met de vinger naar één van de betrokkenen te wijzen) dat
              ...
              <h2
                class="title"
                style="font-size:40px; color:black;"
              >Het is duidelijk: we kunnen vraag en aanbod alleen in gezamenlijkheid effectief bij elkaar brengen.</h2>Wij, partners binnen Ewa Haaglanden, willen daarom sámen jonge mensen zonder
              ...
              <br />
              <br />In ons samenwerkingsverband gaan we daarom de komende jaren, tot en met 2024:
              <br />
              <br />
              <ul class="list-group" style="text-align:left">
                ...
                >Minimaal 1692 kandidaten die doorstromen naar niveau 2 een meer arbeidsmarktrelevante leeromgeving bieden</li>
                <li
                  class="list-group-item list-group-item-dark"
                >Minimaal 47 kandidaten binnen bedrijven relevant verder opleiden</li>
                <li class="list-group-item list-group-item-dark">
